...
def execute_loop_and_save_iamges(data):
    for i in range(len(marcos)):
        ...
        axs[1,0].set(ylabel='tipo = P')
        axs[2,0].set(ylabel='tipo = N')
        axs[3,0].set(ylabel='tipo = A')
        ...
        sns.distplot(data[(data['color']=='verde') & (data['1D_tipo']=='P')][marcoObjetivo], hist=False, color="g", kde_kws={"shade": True}, ax=axs[1,0])
        sns.distplot(data[(data['color']=='rojo') & (data['1D_tipo']=='P')][marcoObjetivo], hist=False, color="r", kde_kws={"shade": True}, ax=axs[1,0])
        sns.distplot(data[(data['color']=='verde') & (data['1D_tipo']=='N')][marcoObjetivo], hist=False, color="g", kde_kws={"shade": True}, ax=axs[2,0])
        sns.distplot(data[(data['color']=='rojo') & (data['1D_tipo']=='N')][marcoObjetivo], hist=False, color="r", kde_kws={"shade": True}, ax=axs[2,0])
        sns.distplot(data[(data['color']=='verde') & (data['1D_tipo']=='A')][marcoObjetivo], hist=False, color="g", kde_kws={"shade": True}, ax=axs[3,0])
        sns.distplot(data[(data['color']=='rojo') & (data['1D_tipo']=='A')][marcoObjetivo], hist=False, color="r", kde_kws={"shade": True}, ax=axs[3,0])
        
        sns.distplot(data[(data['color']=='verde') & (data['1H_tipo']=='P')][marcoObjetivo], hist=False, color="g", kde_kws={"shade": True}, ax=axs[1,1])
        sns.distplot(data[(data['color']=='rojo') & (data['1H_tipo']=='P')][marcoObjetivo], hist=False, color="r", kde_kws={"shade": True}, ax=axs[1,1])
        sns.distplot(data[(data['color']=='verde') & (data['1H_tipo']=='N')][marcoObjetivo], hist=False, color="g", kde_kws={"shade": True}, ax=axs[2,1])
        sns.distplot(data[(data['color']=='rojo') & (data['1H_tipo']=='N')][marcoObjetivo], hist=False, color="r", kde_kws={"shade": True}, ax=axs[2,1])
        sns.distplot(data[(data['color']=='verde') & (data['1H_tipo']=='A')][marcoObjetivo], hist=False, color="g", kde_kws={"shade": True}, ax=axs[3,1])
        sns.distplot(data[(data['color']=='rojo') & (data['1H_tipo']=='A')][marcoObjetivo], hist=False, color="r", kde_kws={"shade": True}, ax=axs[3,1])
        ...
        meanG = data[(data['color']=='verde') & (data['1H_tipo']=='P')][marcoObjetivo].mean()
        medianG = data[(data['color']=='verde') & (data['1H_tipo']=='P')][marcoObjetivo].median()
        axs[1,1].axvline(meanG, color='g', linestyle='-')
        axs[1,1].axvline(medianG, color='g', linestyle='--')
        meanR = data[(data['color']=='rojo') & (data['1H_tipo']=='P')][marcoObjetivo].mean()
        medianR = data[(data['color']=='rojo') & (data['1H_tipo']=='P')][marcoObjetivo].median()
        axs[1,1].axvline(meanR, color='r', linestyle='-')
        axs[1,1].axvline(medianR, color='r', linestyle='--')
        
        meanG = data[(data['color']=='verde') & (data['1H_tipo']=='N')][marcoObjetivo].mean()
        medianG = data[(data['color']=='verde') & (data['1H_tipo']=='N')][marcoObjetivo].median()
        axs[2,1].axvline(meanG, color='g', linestyle='-')
        axs[2,1].axvline(medianG, color='g', linestyle='--')
        meanR = data[(data['color']=='rojo') & (data['1H_tipo']=='N')][marcoObjetivo].mean()
        medianR = data[(data['color']=='rojo') & (data['1H_tipo']=='N')][marcoObjetivo].median()
        axs[2,1].axvline(meanR, color='r', linestyle='-')
        axs[2,1].axvline(medianR, color='r', linestyle='--')
        
        meanG = data[(data['color']=='verde') & (data['1H_tipo']=='A')][marcoObjetivo].mean()
        medianG = data[(data['color']=='verde') & (data['1H_tipo']=='A')][marcoObjetivo].median()
        axs[3,1].axvline(meanG, color='g', linestyle='-')
        axs[3,1].axvline(medianG, color='g', linestyle='--')
        meanR = data[(data['color']=='rojo') & (data['1H_tipo']=='A')][marcoObjetivo].mean()
        medianR = data[(data['color']=='rojo') & (data['1H_tipo']=='A')][marcoObjetivo].median()
        axs[3,1].axvline(meanR, color='r', linestyle='-')
        axs[3,1].axvline(medianR, color='r', linestyle='--')
        
        fig.savefig(carpeta + "pred por tipo " + nombresFicheros[i])
        plt.close(fig)
